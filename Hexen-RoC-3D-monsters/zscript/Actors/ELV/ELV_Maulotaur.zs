class CMaulotaur : Actor replaces Minotaur
{
	...
	{
	Spawn:
		MLTD DEFGHIJKLMNOPQRSTUVWX 3 A_MinotaurLook;
		Loop;
	Roam:
		MLTE GHIJKLMNOPQRSTUVWXYZ[ 1 A_MinotaurRoam;
		Loop;
	See:
		MLTE GHIJKLMNOPQRSTUVWXYZ[ 1 A_MinotaurChase;
		Loop;
	Melee:
		MLTA ABCDEFGHIJKLMNOP 1 A_FaceTarget;
		MLTA Q 6 A_MinotaurAtk1;
		MLTA RSTUVWXYZ[\] 1;
		MLTB A 1;
		MLTB B 1;
		Goto See;
	Missile:
		MLTB C 5 A_MinotaurDecide;
		MLTB CDEFGHIJKLMNO 1 A_FaceTarget;
		MLTB P 1 A_MinotaurAtk2;
		MLTB QRSTUVWXYZ[\ 1;
		Goto See;
	Hammer:
		MLTA ABCDEFGHIJKLMNOP 1 A_FaceTarget;
		MLTA Q 6 A_MinotaurAtk3;
		MLTA RSTUVWXYZ[\] 1;
		MLTB A 1;
		MLTB B 12;
		Goto See;
	HammerLoop:
		...
		Goto Hammer;
	Charge:
		MLTD YZ[\] 1 A_MinotaurCharge;
		MLTE ABCDEF 1 A_MinotaurCharge;
		MLTD YZ[\] 1 A_MinotaurCharge;
		MLTE ABCDEF 1 A_MinotaurCharge;
		Loop;
	Pain:
		...
		Goto See;
	Death:
		MLTB ] 2 A_MinotaurDeath;
		MLTC ABCD 2;
		MLTC E 2 A_Scream;
		MLTC FGHIJKL 2;
		MLTC M 2 A_NoBlocking;
		MLTC NOPQ 2;
		MLTC R -1 A_BossDeath;
		Stop;
	FadeOut:
		MLTA A 2;
		MLTA B 2 A_Scream;
		MLTA C 2 A_SpawnItemEx("MinotaurSmokeExit");
		MLTA DEFGHIJKLMN 2;
		MLTA O 2 A_NoBlocking;
		MLTA P 5 A_SetTranslucent(0.66, 0);
		MLTA Q 5 A_SetTranslucent(0.33, 0);
		MLTA R 5 A_BossDeath;
		Stop;
	}
...
class CMinotaurFriend : CMaulotaur
{
	int StartTime;
